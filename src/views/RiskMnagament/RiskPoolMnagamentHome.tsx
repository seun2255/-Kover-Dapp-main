...
function RiskPoolMnagamentHome() {
  const { theme } = React.useContext(UserContext)
  return (
    <div>
      <Header name="Risk Pool Management" showBackAero={true} />
          ...
          <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-5 pt-5 lg:pt-2">
              <div className="grid grid-cols-2 sm:gap-5 gap-2.5">
                ...
                />
                <SelectField label="Status" placeholder="Please select" />
              </div>
              <SelectField
                label="Admin Address"
...
export default RiskPoolMnagamentHome
