...
function RiskMnagamentCar() {
  const { theme } = React.useContext(UserContext)
  return (
    <div>
      <Header name="Risk Management" showBackAero={true} />
      <div className="flex items-center justify-between mb-5">
        <span className="text-dark-300">Car cover PRP </span>
        ...
        <div className="flex-grow">
          ...
          <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-5 sm:pt-2 max-[640px]:pt-6">
              ...
              <SelectField label="Car Usage" placeholder="Please select" />
              <div className="grid grid-cols-2 sm:gap-5 gap-2.5">
                <SelectField
...
export default RiskMnagamentCar
