      ...
      <div className="flex justify-between w-full">
        <div className="">
          <div className="flex gap-[6px] mb-[5px]">
            <span className="premium-no dark:premium-no-dark">2,345</span>
      ...
      <div className="w-full">
        <div className="mt-[19px]">
          ...
          <div className="flex gap-[6px] ml-[10px]">
            <h4 className="policy-balance dark:policy-balance-dark">3.4330</h4>
            <b className="usd">USD</b>
          </div>
        </div>
        <div className="status-info-sub-info">
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="flex justify-start mt-[5px]">
              ...
              &nbsp;
              <b className="slc-usd-pulse dark:slc-usd-pulse-dark"> +12%</b>
            </div>
