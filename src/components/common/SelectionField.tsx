...
function SelectionField({ toggle, variety, ...rest }: RadioFieldProps) {
  ...
  return (
    <label className="selection-box">
      ...
      <div onClick={toggle} className="selection-assets z-1">
        <img src={model[0]} className="checked-selection" alt="" width={20} height={20} />
        <img src={model[1]} className="unchecked-selection" alt="" width={20} height={20} />
      </div>
    </label>
  );
}
