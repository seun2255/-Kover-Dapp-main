  ...
  return (
    <React.Fragment>
      <div className="hidden sm:block">
        {
          theme === 'dark'
          ? <><img className="w-1" onClick={toggle} src={ open ? `/images/dark-more-1.svg` : `/images/dark-more-2.svg`} alt="" role="button"/></>
          : <> <img className="w-1" onClick={toggle} src={ open ? `/images/Mask (10).svg` : `/images/more-grey.svg`} alt="" role="button"/> </> 
        }
        {open && (
        ...
        <button type="button" onClick={()=>{ toggle();}}>
          {
            ...
            ? 
              <>
                <img className="w-1 float-right sm:hidden" src={ open ? `/images/dark-more-1.svg` : `/images/dark-more-2.svg`} alt="" />
              </>
              :
              <>
              <img className="w-1 float-right sm:hidden" src={ open ? `/images/Mask (10).svg` : `/images/more-grey.svg`} alt="" />
              </>
          }
        </button>
        {open && (
          <div className="absolute z-10">
            <div onClick={toggle} className="fixed top-0 right-0 bottom-0 left-0 bg-transparent -z-[1] " />
