  ...
  return (
    ...
    <div className="hidden sm:flex gap-6 px-7 py-5">
      ...
      {columns.map(({ name, width }, index) => (
        <>
          <div key={index} className={`flex items-center gap-1 ${width}
            ${tableId === 3 ? `${totalItem === index ? "justify-center" : "justify-start"}` : ``}`}>
            ...
            <div>
              ...
              <div className="App">
              <img  id={"app-title"+index}
                  src={`${index === currentIcon ? "/images/info-green-icon.svg" : "/images/Maskd (2).svg"}`}
                  width={10}
                  height={10}
